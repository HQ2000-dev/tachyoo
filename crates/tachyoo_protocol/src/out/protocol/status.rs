...
use crate::{constants::{PROTOCOL_VERSION, STRING_VERSION}, out::{Transfer, packet::Packet, types::{UUID, string::McString}}};
...
pub fn status_response(/*players_max: u32, players_online: u32, player_samples: Option<&[UUID]>*/) -> StatusResponse {
